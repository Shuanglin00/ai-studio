...
public class DocumentInitializer {
	...
	public void learnStr(HttpRequest request, String str) {
		readDocumentFromStr(request,str);
	}
	 ...
	 * @param str 要处理的文档字符串。
	 */
	private void readDocumentFromStr(HttpRequest request,String str) {
		String userId =request.getHeaders().get("sender").toString();
		String groupId = request.getHeaders().get("groupId").toString();
